...
async def GetSummary(urls: URL):
    ...
    userString1= f"{urls.search} Provide an explainantion to the given query. use HTML H and p tags for headings and paragraphs, your response will be used in an webpage as is "
